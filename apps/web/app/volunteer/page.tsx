				...
				<CardHeader>
					<div className="flex items-center justify-between">
						<div>
							...
							<CardDescription>
								Set your skills, location, and availability to get matched with
								disaster zones.
							</CardDescription>
						</div>
		...
		<div className="space-y-6 pt-4">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						See help requests, volunteers, and resources nearby.
					</CardDescription>
				</CardHeader>
				<CardContent>
				...
				<CardContent>
					{isLoading ? (
						...
						<p className="text-muted-foreground">
							No active missions. You'll be notified when assigned.
						</p>
					) : (
							...
							{activeMissions.map((mission) => (
								...
								>
									...
									{mission.userName && (
										<p className="text-sm">
											Victim:{" "}
											<span className="font-medium">{mission.userName}</span>
											{mission.userPhone && (
									...
									<p className="text-sm text-muted-foreground">
										Location: {mission.latitude.toFixed(4)},{" "}
