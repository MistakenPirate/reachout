...
router.get("/missions", authenticate, authorize("volunteer"), volunteerController.getMyMissions);
router.patch("/missions/:id/status", authenticate, authorize("volunteer"), volunteerController.updateMissionStatus);
