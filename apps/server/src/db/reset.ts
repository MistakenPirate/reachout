		...
		.values([
			{
				...
				description:
					"Severe flooding in low-lying areas of Chennai due to heavy monsoon rainfall. Multiple neighborhoods submerged.",
				latitude: 13.0827,
				longitude: 80.2707,
				radiusKm: 12,
				severity: "critical",
			...
			},
			{
				...
				description:
					"Landslide and structural collapses in western suburbs after 48h continuous rain.",
				latitude: 19.076,
				longitude: 72.8777,
				radiusKm: 5,
				severity: "high",
			...
			},
			{
				...
				description:
					"Factory fire in Bawana industrial area. Nearby residences being evacuated.",
				latitude: 28.7041,
				longitude: 77.1025,
				radiusKm: 3,
				severity: "high",
	...
	await db.insert(schema.helpRequests).values([
		{
			...
			peopleCount: 4,
			description:
				"Water level rising in ground floor. Two elderly members unable to move. Need evacuation urgently.",
			status: "in_progress",
			priorityScore: 9,
		...
		},
		{
			...
			peopleCount: 2,
			description:
				"Diabetic patient running out of insulin. Need medical supplies delivered.",
			status: "assigned",
			priorityScore: 8,
		...
		},
		{
			...
			peopleCount: 6,
			description:
				"Building partially collapsed. Family trapped on 3rd floor. Can hear them responding.",
			status: "pending",
			priorityScore: null,
		...
		},
		{
			...
			peopleCount: 3,
			description:
				"Smoke inhalation. Family evacuated but one child has breathing difficulty.",
			status: "pending",
			priorityScore: null,
