...
async function seed() {
  ...
  console.log("  Disaster zones created");
  ...
  console.log("  Admin:      admin@reachout.io");
  console.log("  Victims:    priya@example.com, rahul@example.com, anita@example.com, karan@example.com");
  console.log("  Volunteers: amit@example.com, sneha@example.com, vikram@example.com");
