...
export const emergencyTypeSchema = z.enum(["medical", "flood", "fire", "earthquake", "other"]);
export const requestStatusSchema = z.enum(["pending", "assigned", "in_progress", "resolved"]);
export const resourceTypeSchema = z.enum(["food", "water", "medical_supplies", "shelter_kit", "other"]);
export const resourceStatusSchema = z.enum(["available", "deployed", "depleted"]);
export const volunteerStatusSchema = z.enum(["available", "on_mission", "unavailable"]);
